...
@Metadata(howdoI = "Split a button layout into left and right groups", description = "Learn how to use Vaadin HorizontalLayout to group contents into left and right groups.", tags = {
    Tag.LAYOUT })
