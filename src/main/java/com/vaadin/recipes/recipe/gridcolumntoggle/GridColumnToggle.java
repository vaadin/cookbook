...
@Metadata(howdoI = "Show a menu to toggle the visibility of grid columns", description = "Add a dropdown menu to allow your users to toggle the visibility of Vaadin grid columns.", tags = {
    Tag.GRID })
