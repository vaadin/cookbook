...
@Metadata(howdoI = "Highlight the subtree of a selected parent node", description = "How to highlight the sub-tree of a highlighted row in a Vaadin TreeGrid.", sourceFiles = {
