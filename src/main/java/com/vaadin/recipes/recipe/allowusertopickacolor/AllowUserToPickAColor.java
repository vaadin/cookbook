...
@Metadata(howdoI = "Allow the user to pick a color", description = "Learn how to implement a color picker input field in a Vaadin Java view. Define the server-side API for an HTML color input field and synchronize values.", sourceFiles = "ColorPicker.java")
