...
@Metadata(
    howdoI = "Make a scrollable dialog with a fixed header & footer",
    description = "Learn how to create a scrollable dialog with a fixed header and footer.",
    sourceFiles = {
        "recipe/scrollabledialog/scrollable-dialog.css", "recipe/scrollabledialog/scrollable-dialog-renderer.css",
    }
)
@CssImport(themeFor = "vaadin-dialog-overlay", value = "./recipe/scrollabledialog/scrollable-dialog.css")
@CssImport(value = "./recipe/scrollabledialog/scrollable-dialog-renderer.css")
