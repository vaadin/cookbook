...
@Metadata(howdoI = "Set grid cell background color dynamically", description = "Learn how to change the cell background color of a Vaadin grid, based on any dynamic data.", sourceFiles = {
    "recipe/dynamicgridcellbackgroundcolor/dynamic-grid-cell-background-color.css" }, tags = { Tag.THEME, Tag.GRID })
...
public class DynamicGridCellBackgroundColor extends Recipe {
  ...
  public DynamicGridCellBackgroundColor() {
    ...
    expensesGrid.getColumnByKey("expense")
