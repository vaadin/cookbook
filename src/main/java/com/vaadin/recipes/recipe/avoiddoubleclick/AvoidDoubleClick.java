...
@Metadata(howdoI = "Avoid double-clicks on a Button", description = "Prevent accidental double submits of forms and other double clicks on buttons with this Vaadin Java code snippet.", tags = {
    Tag.USABILITY })
