...
@Route("notice-closed")
@Metadata(howdoI = "Notice when a user closes their browser tab", description = "Use the Beacon API to get notified when a user closes a tab in a Vaadin application so you can run cleanup tasks.")
