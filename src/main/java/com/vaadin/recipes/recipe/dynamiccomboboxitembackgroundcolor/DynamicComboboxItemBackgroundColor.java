...
@CssImport(
    ...
    value = "./recipe/dynamic-combobox-item-background-color/vaadin-combo-box-item-internals-styles.css"
)
@CssImport(value = "./recipe/dynamic-combobox-item-background-color/vaadin-combo-box-item-styles.css")
public class DynamicComboboxItemBackgroundColor extends Recipe {
    ...
    public DynamicComboboxItemBackgroundColor() {
        ...
        customItemBackground.setItems("Good #1", "Bad #1", "Good #2", "Good #3", "Bad #2");

        customItemBackground.setRenderer(
        ...
        customItemBackground.getElement().setAttribute("theme", "custom-item-background");
