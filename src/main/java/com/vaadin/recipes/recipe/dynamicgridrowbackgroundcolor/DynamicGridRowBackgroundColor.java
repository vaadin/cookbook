...
@Metadata(howdoI = "Set grid row background color dynamically", description = "Learn how to change the row background color of a Vaadin grid, based on any dynamic data.", sourceFiles = {
