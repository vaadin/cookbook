...
@Metadata(
    ...
    sourceFiles = { "recipe/dialog-slide-in-out/vaadin-dialog-overlay-styles.css" }
)
@CssImport(themeFor = "vaadin-dialog-overlay", value = "./recipe/dialog-slide-in-out/vaadin-dialog-overlay-styles.css")
