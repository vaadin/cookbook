...
@Route("camera")
@Metadata(howdoI = "Take a photo with my phone", description = "Let users capture and upload pictures with the camera on their mobile device. Customize the Vaadin upload component to capture photos.")
