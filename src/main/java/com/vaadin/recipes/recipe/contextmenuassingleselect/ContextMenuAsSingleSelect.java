...
public class ContextMenuAsSingleSelect extends Recipe {
    ...
    public ContextMenuAsSingleSelect() {
        ...
        singleSelectContextMenu.setRenderer(
            item -> {
        ...
        binder.forField(singleSelectContextMenu).bind(AnyBindableBean::getPerson, AnyBindableBean::setPerson);

        binder.setBean(bean);

        singleSelectContextMenu.addValueChangeListener(
            valueChangeEvent -> {
