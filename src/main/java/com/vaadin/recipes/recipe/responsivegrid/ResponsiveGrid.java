...
@Metadata(howdoI = "Make a responsive Grid that has a different set of columns depending on the browser width.", description = "This recipe demonstrates example of a responsove Grid. It has a different set of columns depending on the browser width. When the browser is narrow one column which combines all the info is shown, and on the wide browser four columns is shown. Resize the browser to see it in action.", sourceFiles = {
        "Person.java" }, tags = { Tag.GRID, Tag.FLOW, Tag.USABILITY })
