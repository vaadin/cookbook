...
@Metadata(
    howdoI = "Show an image in a Grid cell",
    description = "Convert byte array aka blob to Base64 encoded to be shown as inline image with TemplateRenderer",
    tags = { Tag.GRID }
)
