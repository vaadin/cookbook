...
@Metadata(howdoI = "Use a custom date format with DatePicker", description = "Define custom patterns for parsing manually entered dates in Vaadin DatePicker.", sourceFiles = {
